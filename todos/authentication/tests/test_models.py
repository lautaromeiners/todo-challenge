...
class TestUser(TestCase):
    ...
    def test_create_user(self):
        ...
        user = User.objects.create_user(email='testuser@example.com', username='Test',password='password123')
        self.assertEqual(user.email, 'testuser@example.com')
        self.assertTrue(user.check_password('password123'))  # Verifies the password is hashed and works
